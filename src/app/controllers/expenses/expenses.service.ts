...
import { DTODictionary, DTOLoadTable, DTOModalOpen } from './dto/expenses.dto';
...
export class ExpensesService {
    ...
    private async loadDictionary(): Promise<void> {
        try {
            var response = await this._genericService.getDictionary<DTODictionary>(`expenses/${this._localStorage.language}.json`);
